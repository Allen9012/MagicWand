...
const (
	...
	// when flag is flagMustKeep, span need set the tag TagSamplingPriority with value HighestSamplingPriority
	HighestSamplingPriority = "999"
	...
	// TagEcode is defined business codes of ecode platform
	TagEcode = "ecode"

	// TagMirror is defined mirror id.
	TagMirror = "mirror"
...
var (
	SpanKindClientTag = TagString(TagSpanKind, "client")
	SpanKindServerTag = TagString(TagSpanKind, "server")
)
